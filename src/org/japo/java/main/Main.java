    ...
    public static void main(String[] args) {
        ...
        while (exit != 1) {
            ...
            try {
                ...
                System.out.print("Por favor, inserte un número entero ...: ");
                userValue = SCN.nextInt();

                //Si el valor es correcto, se lo mostraremos
                System.out.printf("Usted insertó ...: %d%n", userValue);
